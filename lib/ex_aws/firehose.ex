defmodule ExAws.Firehose do
  ...
  @spec describe_delivery_stream(
          stream_name :: stream_name,
          opts :: describe_delivery_stream_opts
  ...
  @spec create_delivery_stream(stream_name :: stream_name, opts :: create_delivery_stream_opts) ::
          ExAws.Operation.JSON.t()
  def create_delivery_stream(stream_name, opts \\ []) do
    data =
      opts
      |> camelize_keys
      |> Map.merge(%{
  ...
  @spec put_record_batch(stream_name :: stream_name, records :: [put_record_batch_record]) ::
          ExAws.Operation.JSON.t()
  ...
  @spec update_destination(
          stream_name :: stream_name,
          version_id :: binary,
          destination_id :: binary
        ) :: ExAws.Operation.JSON.t()
  @spec update_destination(
          stream_name :: stream_name,
          version_id :: binary,
          destination_id :: binary,
          opts :: update_destination_opts
        ) :: ExAws.Operation.JSON.t()
